...
export const codeReviewPrompts = {
     ...
     * Prompt for top-level directories
     */
    topLevelPrompt: `You are a senior software engineer performing a comprehensive code review of an entire project. This is the TOP-LEVEL directory, so provide a high-level overview of the project's architecture and structure, along with key observations about: 1) Security concerns, 2) Architectural patterns and their appropriateness, 3) Major risks or technical debt, 4) Areas that would benefit from refactoring. DO NOT focus on minor formatting issues or stylistic preferences. Be practical and constructive in your feedback, and if the codebase looks well-designed, acknowledge that rather than searching for problems.`,
    /**
     * Prompt for directories with children
     */
